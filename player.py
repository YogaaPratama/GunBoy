...
class Hero(ABC):
    ...
    def defend(self, enemy_damage):
        if self.health > 0 :
            if self.health < self.health_def and self._armor > 1:
                self.health -= enemy_damage/self._armor
                self._armor -=1
...
class Hero_1(Hero):
    def __init__ (self, react_x, react_y):
        ...
        Hero.__init__(self, "MrBLACK", 1250, 10, 400 , self.Hero_G, react_x, react_y)
...
class Hero_2(Hero):
    def __init__ (self, react_x, react_y):
        ...
        Hero.__init__(self, "MrRED", 1800, 7, 250, self.Hero_G, react_x, react_y)
...
class Hero_3(Hero):
    def __init__ (self, react_x, react_y):
        ...
        Hero.__init__(self, "MrBRODY", 2000, 6, 100, self.Hero_G, react_x, react_y)
